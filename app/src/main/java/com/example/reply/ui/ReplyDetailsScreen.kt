    ...
    Box(modifier = modifier) {
        LazyColumn(
            ...
            item {
                ...
                val detailsPadding = if (isFullScreen) PaddingValues(horizontal = dimensionResource(R.dimen.detail_card_outer_padding_horizontal))
                                    else PaddingValues(end = dimensionResource(R.dimen.detail_card_outer_padding_horizontal))
